...
# echo "# COCO"
# poetry run python $SCRIPT -n 2000 -d coco -m "Emu3-Gen-hf" -o $OUT_PATH
# poetry run python $SCRIPT -n 2000 -d coco -m "Emu3-Gen-hf"  -at "block-img-txt" --a @end-image-emu -o $OUT_PATH
# poetry run python $SCRIPT -n 2000 -d coco -m "Emu3-Gen-hf"  -a @end-image-emu  -o $OUT_PATH
...
poetry run python $SCRIPT -n 1000 -m "Emu3-Gen"  -at "block-img-txt" -o $OUT_PATH
